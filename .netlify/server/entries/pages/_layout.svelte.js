import { c as create_ssr_component, e as escape, b as null_to_empty, v as validate_component } from "../../chunks/index2.js";
...
<header class="${escape(null_to_empty(headerClass), true) + " svelte-1hkjlpa"}"><a href="${"/"}"><img src="${"/andrew.png"}" aria-label="${"Andrew Givens"}" alt="${"Andrew Givens"}" class="${"svelte-1hkjlpa"}"></a>
